package com.tcc.monet.sdk.utils
...
fun Activity.showAdsOverlay(
    ...
    if (showProgressBar) {
        val progressBar = ProgressBar(this, null, R.attr.progressBarStyleLarge).apply {
            indeterminateTintList = ContextCompat.getColorStateList(this@showAdsOverlay, R.color.white)
